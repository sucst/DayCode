package cn.atsuc.designmodel.state;

import cn.atsuc.Fanctory.stateModel.demo.Result;
import cn.atsuc.Fanctory.stateModel.demo.StateHandler;
...
/**
 * @author csup
 * @creatTime 2024/5/22 18:49
 * @description
 */
public class StateTest {

    private Logger logger = LoggerFactory.getLogger(StateTest.class);
